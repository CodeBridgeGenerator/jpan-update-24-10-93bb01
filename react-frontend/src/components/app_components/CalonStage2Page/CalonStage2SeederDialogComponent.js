...
import seederData from "./calonStage2.seeder.json";
...
const CalonStage2SeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CalonStage2SeederDialogComponent);
