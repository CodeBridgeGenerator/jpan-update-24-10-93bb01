...
const CalonStage2DataTable = ({ items, fields, onEditRow, onRowDelete, onRowClick, searchDialog, setSearchDialog,   showUpload, setShowUpload,
...
const dropdownTemplate1 = (rowData, { rowIndex }) => <p >{rowData.tajukLatihan?.tajukLatihan}</p>
...
<Column field="tajukLatihan" header="Tajuk Latihan" body={dropdownTemplate1} filter={selectedFilterFields.includes("tajukLatihan")} hidden={selectedHideFields?.includes("tajukLatihan")}  style={{ minWidth: "8rem" }} />
      ...
      {selectedItems.length > 0 ? (
        ...
        <Dialog header="Upload CalonStage2 Data" visible={showUpload} onHide={() => setShowUpload(false)}>
        <UploadService 
          user={user} 
      ...
      <Dialog header="Search CalonStage2" visible={searchDialog} onHide={() => setSearchDialog(false)}>
      Search
    </Dialog>
    <Dialog
        header="Filter Users"
...
export default CalonStage2DataTable;