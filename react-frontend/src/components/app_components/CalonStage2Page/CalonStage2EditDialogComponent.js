...
tajukLatihan: _entity?.tajukLatihan?._id,
        ...
        await client.service("calonStage2").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info calonStage2 updated successfully" });
...
const tajukLatihanOptions = tajukLatihan.map((elem) => ({ name: elem.name, value: elem.value }));
    ...
    return (
        <Dialog header="Edit CalonStage2" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="calonStage2-edit-dialog-component">
