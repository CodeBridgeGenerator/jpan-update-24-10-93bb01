...
import seederData from "./pelulusStage1.seeder.json";
...
const PelulusStage1SeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(PelulusStage1SeederDialogComponent);
