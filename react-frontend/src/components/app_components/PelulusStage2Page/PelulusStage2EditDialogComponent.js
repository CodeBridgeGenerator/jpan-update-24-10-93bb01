...
status: _entity?.status,
        ...
        await client.service("pelulusStage2").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info pelulusStage2 updated successfully" });
    ...
    return (
        <Dialog header="Edit PelulusStage2" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="pelulusStage2-edit-dialog-component">
