...
import seederData from "./pelulusStage2.seeder.json";
...
const PelulusStage2SeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(PelulusStage2SeederDialogComponent);
