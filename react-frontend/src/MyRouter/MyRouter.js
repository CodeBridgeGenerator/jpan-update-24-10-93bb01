...
import SingleStage1Page from "../components/app_components/Stage1Page/SingleStage1Page";
import Stage1ProjectLayoutPage from "../components/app_components/Stage1Page/Stage1ProjectLayoutPage";
import SingleStage2Page from "../components/app_components/Stage2Page/SingleStage2Page";
import Stage2ProjectLayoutPage from "../components/app_components/Stage2Page/Stage2ProjectLayoutPage";
import SingleKategoriPage from "../components/app_components/KategoriPage/SingleKategoriPage";
import KategoriProjectLayoutPage from "../components/app_components/KategoriPage/KategoriProjectLayoutPage";
import SinglePelulusStage1Page from "../components/app_components/PelulusStage1Page/SinglePelulusStage1Page";
import PelulusStage1ProjectLayoutPage from "../components/app_components/PelulusStage1Page/PelulusStage1ProjectLayoutPage";
import SinglePelulusStage2Page from "../components/app_components/PelulusStage2Page/SinglePelulusStage2Page";
import PelulusStage2ProjectLayoutPage from "../components/app_components/PelulusStage2Page/PelulusStage2ProjectLayoutPage";
import SingleCalonStage2Page from "../components/app_components/CalonStage2Page/SingleCalonStage2Page";
import CalonStage2ProjectLayoutPage from "../components/app_components/CalonStage2Page/CalonStage2ProjectLayoutPage";
//  ~cb-add-import~
...
<Route path="/stage1/:singleStage1Id" exact element={<SingleStage1Page />} />
<Route path="/stage1" exact element={<Stage1ProjectLayoutPage />} />
<Route path="/stage2/:singleStage2Id" exact element={<SingleStage2Page />} />
<Route path="/stage2" exact element={<Stage2ProjectLayoutPage />} />
...
<Route path="/pelulusStage1/:singlePelulusStage1Id" exact element={<SinglePelulusStage1Page />} />
<Route path="/pelulusStage1" exact element={<PelulusStage1ProjectLayoutPage />} />
<Route path="/pelulusStage2/:singlePelulusStage2Id" exact element={<SinglePelulusStage2Page />} />
<Route path="/pelulusStage2" exact element={<PelulusStage2ProjectLayoutPage />} />
<Route path="/calonStage2/:singleCalonStage2Id" exact element={<SingleCalonStage2Page />} />
<Route path="/calonStage2" exact element={<CalonStage2ProjectLayoutPage />} />
